...
object GenAndLoadTPCDSData {
  def main(args: Array[String]): Unit = {
    val scaleFactor = "1"
    val codec = "snappy"
    val metastoreURI = "thrift://bic08:9083"
    val dsdgenDir = "/home/byr23/tpcds-kit/tools"
    val warehousePath = "hdfs://bic07/user/byr23/tpcds_warehouse"
    val format = "parquet"
    val useDecimal = true
    val useDate = true
    ...
    val databaseName = s"tpcds320_sf${scaleFactor}" +
